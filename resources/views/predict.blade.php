        ...
        {{ csrf_field() }}
            {{--<div class="popup-form-row">--}}
                ...
                <div class="popup-form-row">
                    ...
                    <input type="text" class="form-control" id="title" name="culture_id" placeholder="Input Culture">
        <span class="required" title="Required field">
                           Вводите значения в формате 'название культуры'
                    </span>
            ...
            <div class="popup-form-row">
                <label for="title">Имя</label>
                <input type="number" class="form-control" id="title" name="quantity" placeholder="Введите дату">
        <span class="required" title="Required field">
                           Введите количество земли
