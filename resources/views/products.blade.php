    ...
    <form method="post" action="/products/products_branch_filter">
        ...
        <p><input type="submit" name="submit_branch" class="btn btn-info" value="Submit Branch" /></p>
                ...
                <div class="table-heading-black">
                    <div class="table-section-small">Type</div>
                    <div class="table-section-big">Outcome</div>
                    <div class="table-section">Branch_Number</div>

                    <div class="table-section">City</div>
                ...
                <ul class="table-list">
                    @foreach($outcome as $o)
                        ...
                        <li class="table-list-item">
                            <div class="table-section-small">{{ $o->type or '?' }}</div>
                            <div class="table-section-big">{{ $o->outcome or '?' }}</div>
                            <div class="table-section">{{ $o->branch or '?' }}</div>
                            {{--@if(!$role->isStaff()) --}}{{-- RESTRICTED FOR STAFF --}}
                            <div class="table-section">{{ $o->city or '?' }}</div>
